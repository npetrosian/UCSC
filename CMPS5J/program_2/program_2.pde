/*
  This program will display a sun overlooking mountains in the ocean. The user will be able to interact with the sun. As the user makes the sun travel down the y-axis, 
  the scene becomes darker. As the user makes the sun travel upwards, the scene becomes brighter. 
 */
...
void draw() {
  ...
  background(backgroundRed, backgroundGreen, backgroundBlue-mouseY);

  // draws the sun
  noStroke();
  fill(sunRed, sunGreen, sunBlue);
  ellipse(mouseX, mouseY, sunWidth, sunHeight);

  // draws the ocean
  noStroke();
  fill(oceanRed, oceanGreen, oceanBlue-mouseY/5);
  rect(oceanX, oceanY, oceanWidth, oceanHeight);

  // draws the mountains
  stroke(88,46,46);
  strokeWeight(2);
  fill(firstMountainRed, firstMountainGreen-mouseY/3, firstMountainBlue);
  triangle(firstMountainX1, firstMountainY1, firstMountainX2, firstMountainY2, firstMountainX3, firstMountainY3);

  fill(secondMountainRed, secondMountainGreen-mouseY/3, secondMountainBlue);
  triangle(secondMountainX1, secondMountainY1, secondMountainX2, secondMountainY2, secondMountainX3, secondMountainY3);

  fill(thirdMountainRed, thirdMountainGreen-mouseY/3, thirdMountainBlue);
